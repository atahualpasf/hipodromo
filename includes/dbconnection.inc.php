      ...
      return '/hipodromo/includes/';
		...
		************************************************************/
		function getPropietarios() {
			...
			FROM propietario pro, lugar p, lugar m, lugar e, telefono t
			WHERE pro.fkpro_lug_id = p.pklug_id AND p.fklug_lug_id = m.pklug_id AND m.fklug_lug_id = e.pklug_id and t.fktel_pro_id = pro.pkpro_id");
