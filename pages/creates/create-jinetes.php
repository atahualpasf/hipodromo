<?php
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $answer = @json_decode($db->createJinete($fkjin_lug_id, $jin_ci, $jin_primer_nombre, $jin_segundo_nombre, $jin_primer_apellido, $jin_segundo_apellido, $jin_fecha_nacimiento, $jin_altura, $jin_experiencia));
              ...
              <div class="box-body">
                  ...
                  <div class="col-xs-3">
                     <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input id="jin_fecha_nacimiento" name="jin_fecha_nacimiento" type="text" class="form-control pull-right" value="<?php $jin_fecha_nacimiento = !empty($jin_fecha_nacimiento) ? $jin_fecha_nacimiento : "1990-01-01"; echo $jin_fecha_nacimiento; ?>" readonly>
                      </div><!-- /.input group -->
                    </div><!-- /.form group -->
                  </div>
                </div>
               ...
               <div class="box-footer">
                 <div class="col-xs-offset-3 col-xs-3">
                    <button name="pkjin_id" value="<?php echo $pkjin_id; ?>" type="submit" class="btn btn-update btn-block btn-flat uppercase">Crear</button>
                 </div>
                 <div class="col-xs-3">
