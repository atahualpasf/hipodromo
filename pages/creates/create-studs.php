<?php
  ...
  $fkstu_lug_id = $stu_nombre = $stu_fecha_creacion = "";
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $answer = @json_decode($db->createStud($fkstu_lug_id, $stu_nombre, $stu_fecha_creacion));
              ...
              <div class="box-body">
               ...
               <div class="box-footer">
                 <div class="col-xs-offset-3 col-xs-3">
                    <button name="pkstu_id" value="<?php echo $pkstu_id; ?>" type="submit" class="btn btn-update btn-block btn-flat uppercase">Crear</button>
                 </div>
                 <div class="col-xs-3">
