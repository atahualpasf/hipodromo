    ...
    <div class="row">
      ...
      <div class="col-lg-6 col-xs-6">
       ...
       <div class="small-box bg-aqua">
          ...
          <a href='../reports/reports.php?report=getEntrenadores' class='small-box-footer'>
            Ver reporte de entrenadores <i class="fa fa-arrow-circle-right"></i>
          </a>
       </div>
     </div><!-- ./col -->
                ...
                <?php
                  foreach ($entrenadoresList as $row) {
                      ...
                      if ((json_decode($db->getPrivilegiosByRol($_SESSION['rol']['pkrol_id'],15))->action != "success") AND (json_decode($db->getPrivilegiosByRol($_SESSION['rol']['pkrol_id'],18))->action != "success")) {
                        echo "<td><button name='pkent_id' value='$row->pkent_id' type='submit' form='deleteForm' class='btn btn-danger btn-flat btn-block' disabled><i class='fa fa-trash'></i></button></td>";
                     } else {
